  ...
  <div class="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
    ...
    >
      ...
      <Column header="Supply">
        <template #body="{ data }"
          ><span class="text-slate-800 text-sm font-medium">{{ data.supply?.name || "—" }}</span></template
        >
      </Column>
