<template>
    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
        ...
        <DataTable :value="medicineDistributions" paginator :rows="15" :rowsPerPageOptions="[10, 15, 25, 50, 100]" responsiveLayout="scroll" tableStyle="min-width: 60rem"
...
onMounted(async () => {
    try {
        await Promise.all([medicineDistributionStore.read(), medicineStockStore.read(), stationStore.read()]);
    } catch (err: any) {
