    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                class="w-full px-4 py-3 rounded-lg border border-slate-200 bg-slate-50 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:bg-white transition"
              />
              <button type="button" @click="showPassword = !showPassword" class="absolute right-3 top-3.5 text-slate-400 hover:text-slate-600 transition">
        ...
        <div class="mt-4 p-3 bg-emerald-50 rounded-lg flex items-start gap-2">
          ...
          <p class="text-xs text-emerald-700">This system is for authorized personnel only. All access is monitored and logged.</p>
        </div>
      </div>
